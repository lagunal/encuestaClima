...
<tr><td class="Detalle">Número de Datos <?php echo $startrec + 1 ?> - <?php echo $reccount ?> of <?php echo $count ?></td></tr>
</table>
<hr size="1" noshade>
...
?>
<tr>
<td bgcolor="#F3F3F3"><a class="Detalle" href="edicionDatos.php?a=view&codigo=<?php echo $row["codigo_norma"];?>&recid=<?php echo $i ?>">Ver</a></td>
<td bgcolor="#F3F3F3"><a class="Detalle" href="edicionDatos.php?a=edit&codigo=<?php echo $row["codigo_norma"];?>&recid=<?php echo $i ?>">Editar</a></td>
<td bgcolor="#F3F3F3"><a class="Detalle" href="edicionDatos.php?a=del&codigo=<?php echo $row["codigo_norma"];?>&recid=<?php echo $i ?>">Eliminar</a></td>
...
<?php 
	...
	function sql_select()
	{
	  ...
	  if (isset($filterstr) && $filterstr!='' && isset($filterfield) && $filterfield!='') {
	    $sql .= " where lower(" .sqlstr($filterfield) .") like '" .$filterstr ."'";
	  } elseif (isset($filterstr) && $filterstr!='') {
	    $sql .= " where (lower(tx_codigo) like '" .$filterstr ."') or (lower(tx_nombre) like '" .$filterstr ."')";
	  }
