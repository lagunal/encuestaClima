...
$totalEncuestasOficina = $clad->obtenerEncuestasOficina();

		
//	if ($totalRows_opciones > 0){
	    $data[0] = $totalEncuestasOficina;
		$data[1] = $totalEncuestas - $totalEncuestasOficina;
//    }
...
$graph->title->Set("ENCUESTAS RESPONDIDAS POR OFICINA");
...
//$p1->ExplodeSlice($max);
$p1->SetLegends(array("Encuestas respondidas por oficina","Encuestas respondidas fuera de oficina"));
$p1->SetSize($size);
