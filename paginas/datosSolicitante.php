        ...
        <td valign="top" align="left">
            <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="right">
                        <div align="left">
                            <input name="lugar" type="text" size="45" maxlength="50" disabled>
                        </div>
                    </td>
                    <td class="Detalle">13. Fecha:</td>
                    <td>
                    	<input name="fecha" type="text" size="6" value="<?php echo date("m/d/Y"); ?>" disabled  >
                    </td>
                </tr>
                <tr>
                    <td align="right" class="Detalle">
                    ...
                    <td align="right">
                        <div align="left">
                            <input name="filial" type="text" size="45" maxlength="50" disabled>
                        </div>
                    </td>
                </tr>
                <tr>
