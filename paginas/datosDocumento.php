        ...
        <td valign="top">
            <table border="0" align="center" bgcolor="#FFFFFF" cellpadding="2" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan="2">
                    	<textarea name="texta4" class="Detalle" cols="60" rows="2" id="texta4" onkeydown="checklength(texta4,remLen3,254);" onkeyup="checklength(texta4,remLen3,254)"></textarea>
                    	<input readonly type="text" name="remLen3" size="3" maxlength="3" value="254">
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="right" class="Detalle">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <textarea name="txObser2" class="Detalle" cols="60" rows="2" id="txObser2" onkeydown="checklength(txObser2,remLen2,254);" onkeyup="checklength(txObser2,remLen2,254);"></textarea>
                        <input readonly type="text" name="remLen2" size="3" maxlength="3" value="254"> 
                    </td>
                </tr>
            </table>
