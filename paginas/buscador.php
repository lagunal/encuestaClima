				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
							<tr>
								<td width="180px" valign="top" rowspan="4" height="100%">
									<img src="../imagenes/SANTP_afiche.jpg">
								</td>
							</tr>
							<tr>
								<td width="580px" height="20px" valign="top">
									<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
										<tr>
											<td width="580px" height="20px" valign="top" class="Titulo">
												MOTOR DE BÚSQUEDA
											</td>
										</tr>
										<tr>
												...
												<form id="form1" method="post" style="margin:0px">
													...
													<table cellpadding="0" cellspacing="0" border="0">
														<tr>
															...
															<td width="240px">
																<input type="text" id="txtBuscar" name="txtBuscar" size="40" class="Detalle" maxlength="20" value="<?php if(isset($_POST["txtBuscar"])) echo $_POST["txtBuscar"]; ?>"/>
															</td>
															<td width="95px">
